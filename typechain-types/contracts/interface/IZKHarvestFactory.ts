...
export interface IZKHarvestFactoryInterface extends utils.Interface {
  functions: {
...
export interface IZKHarvestFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IZKHarvestFactoryInterface;
