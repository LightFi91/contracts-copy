...
export interface ITreasurerInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "claimReward" | "rewardUser"
  ): FunctionFragment;
...
export interface ITreasurer extends BaseContract {
