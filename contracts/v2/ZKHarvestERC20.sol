...
contract ZKHarvestERC20 is IZKHarvestERC20 {
    ...
    string public constant symbol = 'ZKH-LP';
    ...
    function transfer(address to, uint value) virtual external returns (bool) {
        require(to != address(0), 'zkHarvest: TO cannot be the zero address');
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'zkHarvest: INVALID_SIGNATURE');
