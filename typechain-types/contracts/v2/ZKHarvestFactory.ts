...
export interface ZKHarvestFactoryInterface extends utils.Interface {
  functions: {
...
export interface ZKHarvestFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZKHarvestFactoryInterface;
