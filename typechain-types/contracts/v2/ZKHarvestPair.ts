...
export interface ZKHarvestPairInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "sFee", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "sFee", data: BytesLike): Result;
...
export interface ZKHarvestPair extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZKHarvestPairInterface;
  ...
  functions: {
    ...
    sFee(overrides?: CallOverrides): Promise<[BigNumber]>;

    setFees(
      _lpFee: PromiseOrValue<BigNumberish>,
      _sFee: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  populateTransaction: {
    ...
    sFee(overrides?: CallOverrides): Promise<PopulatedTransaction>;
